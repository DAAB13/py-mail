...
- [x] Instalación de stack (`uv`, `loguru`, `pywin32`).
- [x] Cargadores de datos Parquet (Refactorizado).
- [x] Modelos de dominio con Dataclasses.
- [x] Servicio de Outlook con reconexión RPC y guardado automático.
...
- [ ] Previsualización de plantillas en tiempo real.
- [ ] Dashboard de estados de envío.
