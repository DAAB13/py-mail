...
### (F3) Informe semanal                                                                               
- **Entrada**: Ninguna (automática).                                                                        
- **Lógica**: Agrupa información relevante de la semana (a definir).                                        
- **Salida**: Un correo único a un destinatario fijo (`fixed_recipient` en `config.toml`).
